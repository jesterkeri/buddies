...
function getDefaultEvents(): ActivityEvent[] {
  ...
  return [
    ...
    { id: '5', type: 'opportunity', agent: 'Tracker', content: 'Found 3 new hackathon matches — 95% skill overlap', timestamp: now - 60000 },
    { id: '6', type: 'break', agent: 'Beans', content: 'Reminder: You\'ve been coding for 2 hours. Time to stretch!', timestamp: now - 30000 },
    ...
    { id: '10', type: 'break', agent: 'Beans', content: 'Great work fixing that bug! You earned a coffee break ☕', timestamp: now },
  ].reverse();
}
